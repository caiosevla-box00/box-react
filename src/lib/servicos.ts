...
export const SERVICOS: Servico[] = [
  ...
  { id:'teto',      num:'06', nome:'Limpeza de Teto',            tempo:'45min',      base:{hatch:60,  sedan:72,  suv:78 },  desc:'APC (limpador multiuso) no forro do teto · Produto Vonixx específico que flora os tecidos e remove manchas e resíduos impregnados · Processo 100% manual com flanelas específicas' },
  ...
  { id:'plastext',  num:'14', nome:'Revit. Plásticos Externos',  tempo:'40min',      base:{hatch:35,  sedan:42,  suv:45 },  desc:'Restaurax Vonixx nos plásticos externos · Para-choques, caixas de roda, frisos e soleiras · Devolve a cor original e protege contra UV' },
